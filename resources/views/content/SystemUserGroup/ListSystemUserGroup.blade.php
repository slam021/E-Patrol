    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        <th width="5%" style='text-align:center'>User Group ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" class="btn btn-outline-warning btn-sm " href="{{ url('/system-user-group/edit/'.$usergroup['user_group_id']) }}"><i class="far fa-edit"></i> Edit</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/system-user-group/delete-system-user-group/'.$usergroup['user_group_id']) }}"><i class="fas fa-trash-alt"></i> Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
