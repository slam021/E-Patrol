                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="" style='text-align:center'>
                            <a type="button" class="badge bg-warning" href="{{ url('/system-user/edit/'.$user['user_id']) }}"><i class='fas fa-edit'></i> Edit</a>
                            <a type="button" class="badge bg-danger" href="{{ url('/system-user/delete-system-user/'.$user['user_id']) }}"><i class='far fa-trash-alt'></i> Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
