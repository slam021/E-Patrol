                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" class="btn btn-outline-warning btn-sm " href="{{ url('/system-user/edit/'.$user['user_id']) }}"><i class="far fa-edit"></i> Edit</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/system-user/delete-system-user/'.$user['user_id']) }}"><i class="fas fa-trash-alt"></i> Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
